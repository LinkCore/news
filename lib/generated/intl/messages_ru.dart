...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(howMany) =>
      "${Intl.plural(howMany, one: 'одна минута', two: 'две минуты', other: 'более двух минут')}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "countOfLikes":
            MessageLookupByLibrary.simpleMessage("Количество лайков: "),
        "hello": MessageLookupByLibrary.simpleMessage("Привет, Егор! Сегодня "),
